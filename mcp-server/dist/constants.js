...
export const PLAYER_CATEGORIES = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K'];
export const PYRAMID_LEVELS = ['FYS', 'TEK', 'SLAG', 'SPILL', 'TURN'];
...
export const L_PHASES = ['L-KROPP', 'L-ARM', 'L-KØLLE', 'L-BALL', 'L-AUTO'];
export const CS_LEVELS = ['CS0', 'CS20', 'CS30', 'CS40', 'CS50', 'CS60', 'CS70', 'CS80', 'CS90', 'CS100'];
export const ENVIRONMENTS = ['M0', 'M1', 'M2', 'M3', 'M4', 'M5'];
export const PRESS_LEVELS = ['PR1', 'PR2', 'PR3', 'PR4', 'PR5'];
export const LIFE_CODES = ['LIFE-SELV', 'LIFE-SOS', 'LIFE-EMO', 'LIFE-KAR', 'LIFE-RES'];
export const PERIODS = ['GRUNN', 'SPES', 'TURN'];
export const WEEK_TYPES = ['TURNERINGSUKE', 'TRENINGSUKE'];
export const DRILL_SOURCES = ['ak_original', 'external', 'ai_generated'];
export const DRILL_DIFFICULTIES = ['nybegynner', 'rekrutt', 'klubb', 'regional', 'nasjonal', 'elite'];
export const FYS_SUBTYPES = ['FYS_STYRKE_M0', 'FYS_MOBILITET_M0', 'FYS_POWER_M0'];
export const TURN_SUBTYPES = ['TURN_RES', 'TURN_UTV', 'TURN_TRE'];
export const PUTTING_FOCUSES = ['GREEN', 'SIKTE', 'TEKN', 'BALL', 'SPEED'];
export const SG_AREAS = ['tee', 'approach', 'short_game', 'putting'];
