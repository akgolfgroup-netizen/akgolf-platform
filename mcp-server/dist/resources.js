import { PLAYER_CATEGORIES, PYRAMID_LEVELS, TRAINING_AREAS, L_PHASES, CS_LEVELS, ENVIRONMENTS, PRESS_LEVELS, LIFE_CODES, PERIODS, DISTRIBUTION_TEMPLATES, HOURS_PER_WEEK } from './constants.js';
export function registerResources(server) {
    // ── AK Formula Reference ──────────────────────────────────
    server.registerResource('ak-formula', 'ak://reference/formula', {
    ...
    server.registerResource('ak-distributions', 'ak://reference/distributions', {
    ...
    // ── Hours Per Week ────────────────────────────────────────
    server.registerResource('ak-hours', 'ak://reference/hours', {
    ...
    // ── Invariants ────────────────────────────────────────────
    server.registerResource('ak-invariants', 'ak://reference/invariants', {
