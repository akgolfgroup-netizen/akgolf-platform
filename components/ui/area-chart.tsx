          ...
          return (
            ...
            >
              {formatter && item?.value !== undefined && item.name ? (
                formatter(item.value, String(item.name), item, 0, item.payload) as React.ReactNode
              ) : (
                <>
                  {itemConfig?.icon ? (
                    <itemConfig.icon />
                        ...
                        style={
                          {
                            ...
                            backgroundColor: indicator !== "dashed" ? String(indicatorColor) : undefined,
                  ...
                  >
                    <div className="grid gap-1.5">
                      ...
                      <span className="text-muted-foreground">
                        {(itemConfig?.label || String(item.name)) as React.ReactNode}
                      </span>
                    </div>
                    {item.value != null && (
