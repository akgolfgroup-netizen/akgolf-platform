...
export function Logo({ 
  ...
  // Size configurations
  const sizes = {
    sm: { width: 32, height: 28, textSize: "text-lg" },
    md: { width: 40, height: 35, textSize: "text-xl" },
    lg: { width: 48, height: 42, textSize: "text-2xl" },
  };
      ...
      >
        <g transform="translate(0,470) scale(0.1,-0.1)">
          <path
            ...
            fill={primary}
          />
          <circle cx="4840" cy="3620" r="310" fill="#d2f000" />
        </g>
      </svg>
...
// Simpler version for compact use (just the icon)
