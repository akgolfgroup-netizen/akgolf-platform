            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  <Calendar className="w-5 h-5 text-[var(--color-grey-400)] mt-0.5" />
                  <div>
                ...
                {/* Duration */}
                <div className="flex items-start gap-3">
                  <Clock className="w-5 h-5 text-[var(--color-grey-400)] mt-0.5" />
                  <div>
                ...
                {/* Facility */}
                <div className="flex items-start gap-3">
                  <MapPin className="w-5 h-5 text-[var(--color-grey-400)] mt-0.5" />
                  <div>
                ...
                {event.createdBy && (
                  <div className="flex items-start gap-3">
                    <User className="w-5 h-5 text-[var(--color-grey-400)] mt-0.5" />
                    <div>
                ...
                <div className="pt-6 border-t border-[var(--color-grey-200)] space-y-3">
                  {isPending && onApprove && (
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-[#34C759] text-white font-medium hover:bg-[#2DB84E] transition-colors"
                    >
                  ...
                  {onDelete && (
                    <button
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-[#FF3B30] text-[#FF3B30] font-medium hover:bg-[#FF3B30]/10 transition-colors"
                    >
                      Kanseller aktivitet
                    </button>
                  )}
