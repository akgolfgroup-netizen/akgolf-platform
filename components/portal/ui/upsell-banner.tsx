            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-xs font-semibold bg-white text-[var(--color-brand)] hover:bg-white/90 transition-colors"
                >
      ...
      <>
        ...
        >
          {dismissible && (
            <button
              onClick={handleDismiss}
              className="absolute top-3 right-3 p-1.5 rounded-lg hover:bg-[var(--color-brand)]/10 transition-colors"
            >
    ...
    <>
      ...
      >
        ...
        {dismissible && (
          <button
            onClick={handleDismiss}
            className="ml-2 p-1 rounded-lg hover:bg-[var(--color-brand)]/10 transition-colors"
          >
