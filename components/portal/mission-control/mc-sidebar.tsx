  ...
  return (
    <>
      ...
      <div className="p-4 border-t border-[#E8E8ED]">
        ...
        <button
          onClick={onSignOut}
          className="w-full flex items-center gap-2 px-2 py-2 mt-2 text-[11px] text-[#6E6E73] hover:text-[#FF3B30] hover:bg-[#FF3B30]/10 rounded-lg transition-colors cursor-pointer"
        >
