...
export function MCCard({ children, className }: MCCardProps) {
  return (
    <div
      className={cn(
        "bg-white rounded-xl border border-[var(--color-grey-200)] overflow-hidden",
        className
      )}
    >
      {children}
...
export function MCCardHeader({ children, className }: MCCardHeaderProps) {
  return (
    <div
      className={cn(
        "px-4 py-3 border-b border-[var(--color-grey-200)] flex items-center justify-between",
        className
      )}
    >
      {children}
...
export function MCCardTitle({ children, className }: MCCardTitleProps) {
  return (
    <h3 className={cn("text-[13px] font-semibold text-[var(--color-black)]", className)}>
      {children}
    </h3>
  );
}
...
export function MCCardFooter({ children, className }: MCCardFooterProps) {
  return (
    <div
      className={cn("px-4 py-3 border-t border-[var(--color-grey-200)] bg-[var(--color-surface)]", className)}
    >
      {children}
    </div>
  );
