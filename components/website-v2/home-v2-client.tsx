...
const TESTIMONIALS = [
  {
    quote:
      '"Jeg gikk fra HCP 18 til 11 på elleve måneder. Det er strukturen — månedlig test, ukentlig fokus, alt logget — som gjør forskjellen."',
    initials: "EK",
    name: "Erik Kvist",
    meta: "PERFORMANCE · BÆRUM GK",
    avatarBg: "var(--akgolf-primary, #005840)",
  },
  {
    quote:
      '"Som forelder elsker jeg at jeg ser hva sønnen min trener på, hvor han er og når neste samling er. Apper er ikke gimmick her."',
    initials: "SH",
    name: "Silje Holm",
    meta: "JUNIOR-FORELDRE · 11 OG 14 ÅR",
    avatarBg: "#7AB8E0",
  },
  {
    quote:
      '"Banecoachingen med Markus på 9 hull var det første som faktisk endret hvordan jeg tenker på en runde. Helt annet enn range-lessons."',
    initials: "MJ",
    name: "Magnus Jensen",
    meta: "FLEKSIBEL BOOKING · HCP 14",
    avatarBg: "#D49A6A",
  },
];
    ...
    >
      ...
      >
        <div className="mx-auto max-w-[1280px]">
          ...
          <div className="mt-15 grid gap-6 md:grid-cols-3">
            {TESTIMONIALS.map((t) => (
              ...
              >
                ...
                <blockquote className="mb-[22px] text-[17px] font-medium leading-[1.55] tracking-[-0.01em] text-[var(--akgolf-ink,#0A1F18)] text-pretty">
                  {t.quote}
                </blockquote>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-bold text-[var(--akgolf-ink,#0A1F18)]">
                      {t.name}
                    </div>
                    <div
                      className="text-[10px] tracking-[0.06em] text-[var(--akgolf-muted,#A5B2AD)]"
                      style={{
                        fontFamily: "var(--font-jetbrains-mono), monospace",
                      }}
                    >
          ...
          <div className="mt-10 flex flex-wrap items-center justify-between gap-10 py-10 opacity-55">
            {PARTNERS.map((p) => (
              <span
                key={p}
                className="text-[12px] font-bold tracking-[0.14em] text-[var(--akgolf-text,#324D45)]"
                style={{ fontFamily: "var(--font-jetbrains-mono), monospace" }}
              >
                {p}
              </span>
