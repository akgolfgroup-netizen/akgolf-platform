...
import { ACADEMY_HERO_V3 } from "@/lib/website-constants";

export function AcademyHeroSection() {
  const h = ACADEMY_HERO_V3;
  return (
    <section
      className="relative px-10 pb-20 pt-[140px]"
    ...
    >
      <div className="mx-auto grid max-w-[1280px] items-center gap-15 md:grid-cols-[1.05fr_1fr]">
        <div>
          ...
          <h1
            className="mb-6 text-[clamp(48px,6.5vw,84px)] font-extrabold leading-[0.98] tracking-[-0.038em] text-[var(--akgolf-ink,#0A1F18)] text-balance"
          ...
          <p className="max-w-[52ch] text-[19px] leading-[1.55] text-[var(--akgolf-text,#324D45)] text-pretty">
            {h.description}
          </p>
