...
export function TestimonialBlock() {
  return (
    <section className="py-[120px] md:py-[160px] bg-[#ECF0EF]">
        ...
        <RevealOnScroll>
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-[1fr_240px] gap-12 items-center">
            <div>
              ...
              <div>
                <p className="font-semibold text-[#0A1F18]">{TESTIMONIAL.author}</p>
                <p className="text-sm text-[#5A6E66]">{TESTIMONIAL.detail}</p>
              </div>
            </div>
