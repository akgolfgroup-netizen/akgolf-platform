...
export function TestimonialCard({
  ...
  return (
    <div className="w-card group flex flex-col h-full border-l-[3px] border-l-black">
      <svg width="24" height="24" viewBox="0 0 24 24" className="text-grey-300 mb-4 shrink-0 transition-all duration-300 group-hover:text-black group-hover:scale-110" fill="currentColor">
