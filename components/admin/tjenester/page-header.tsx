...
export function TjenesterPageHeader() {
  return (
    <div className="mb-6 flex items-end justify-between">
      <div>
        ...
        <h1 className="mt-2 font-inter-tight text-[28px] font-bold leading-tight tracking-tight text-white">
          Tjenestekatalog &amp; prising.
        </h1>
        <p className="mt-1.5 max-w-3xl text-[13px] text-white/60">
          Det spillere kan booke. Hver tjeneste har lokasjons-tilknytning, varighet,
          kapasitet og pris. Pakkepriser låser flere økter samtidig. Endringer går live
          ved publisering.
        </p>
      </div>
      <div className="flex items-center gap-2.5">
        ...
        >
          <Upload className="h-3.5 w-3.5" strokeWidth={1.8} /> Importer
        </button>
        <button
          type="button"
