...
export function GrupperPageHeader({
  eyebrow,
  title,
  subtitle,
  primaryLabel = "Ny gruppe",
  ...
  return (
    <div className="mb-6 flex items-end justify-between border-b border-[#1a4a3a] pb-5">
      ...
      <div className="flex items-center gap-2.5">
        ...
        >
          <Filter className="h-3.5 w-3.5" strokeWidth={1.8} /> {secondaryLabel}
        </button>
        <button
          type="button"
        ...
        >
          <Plus className="h-3.5 w-3.5" strokeWidth={1.8} /> {primaryLabel}
        </button>
      </div>
    </div>
  );
