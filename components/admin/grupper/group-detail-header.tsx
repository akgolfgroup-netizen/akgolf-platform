...
export function GroupDetailHeader({ eyebrow, title, subtitle }: Props) {
  return (
    <div className="mb-6 flex items-end justify-between border-b border-[#1a4a3a] pb-5">
      ...
      <div className="flex items-center gap-2.5">
        ...
        >
          <MessageSquare className="h-3.5 w-3.5" strokeWidth={1.8} /> Send melding
        </button>
        <button
          type="button"
        ...
        >
          <CalendarPlus className="h-3.5 w-3.5" strokeWidth={1.8} /> Bok økt
        </button>
      </div>
    </div>
  );
