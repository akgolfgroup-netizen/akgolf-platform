...
type ActivityType = "training" | "tournament" | "course";
        ...
        <AdminCard>
          <form onSubmit={handleSubmit} className="space-y-5">
                ...
                {activityOptions.map((type) => {
                  ...
                  return (
                    <button
                      ...
                      type="button"
                      onClick={() =>
                        setFormData({ ...formData, activityType: type.id })
                      }
                      className={cn(
                        "flex flex-col items-center gap-2 p-4 rounded-xl border transition-all",
                        isActive
                          ? "border-[var(--color-primary)] bg-[var(--color-primary)]/5"
                          : "border-[var(--color-grey-200)] bg-white hover:bg-[var(--color-grey-100)]",
                      )}
                    >
                      <Icon
                        className={cn(
            ...
            <div>
              ...
              <div className="relative">
                <Users className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[var(--color-muted)] pointer-events-none z-10" />
                <AdminInput
                  type="number"
