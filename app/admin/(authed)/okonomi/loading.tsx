    ...
    <div className="space-y-6 animate-pulse">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[...Array(4)].map((_, i) => (
          <div
            key={i}
            className="bg-surface-container-lowest rounded-[20px] border border-[var(--color-grey-200)] p-5"
          >
      ...
      <div className="bg-surface-container-lowest rounded-[20px] border border-[var(--color-grey-200)] p-5">
