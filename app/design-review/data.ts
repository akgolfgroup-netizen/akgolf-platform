...
export const screens: Screen[] = [
  ...
  { route: "/admin/spillere", heritageRef: "admin_player_management", label: "Elever", sprint: "B", auth: "admin", status: "done" },
  { route: "/admin/spillere/demo", heritageRef: "admin_player_profile", label: "Elev-detalj", sprint: "B", auth: "admin", status: "done" },
  ...
  // E2 — Sosialt & Spill
  { route: "/portal/sosialt", heritageRef: "social_feed_community", label: "Sosialt feed", sprint: "E", group: "E2", auth: "portal", status: "done" },
  { route: "/portal/sosialt/venner", heritageRef: "friend_list", label: "Venner", sprint: "E", group: "E2", auth: "portal", status: "done" },
  { route: "/portal/spill", heritageRef: "challenges_quests", label: "Spill", sprint: "E", group: "E2", auth: "portal", status: "done" },
  // E3 — Analyse & AI
  { route: "/portal/analyse", heritageRef: "analytics_ai_recap", label: "Analyse", sprint: "E", group: "E3", auth: "portal", status: "done" },
  { route: "/portal/ai-coach", heritageRef: "", label: "AI-coach", sprint: "E", group: "E3", auth: "portal", status: "done" },
  { route: "/portal/benchmark", heritageRef: "analytics_leaderboard", label: "Benchmark", sprint: "E", group: "E3", auth: "portal", status: "done" },
  { route: "/portal/sammenligning", heritageRef: "head_to_head_versus", label: "Sammenligning", sprint: "E", group: "E3", auth: "portal", status: "done" },
  { route: "/portal/strategi", heritageRef: "coach_prepare_session", label: "Strategi", sprint: "E", group: "E3", auth: "portal", status: "done" },
  // E4 — Utstyr & Tester
  { route: "/portal/bag", heritageRef: "settings_profile", label: "Bag", sprint: "E", group: "E4", auth: "portal", status: "done" },
  { route: "/portal/trackman", heritageRef: "analytics_strokes_gained", label: "TrackMan", sprint: "E", group: "E4", auth: "portal", status: "done" },
  { route: "/portal/tester", heritageRef: "coach_drills_library", label: "Tester", sprint: "E", group: "E4", auth: "portal", status: "done" },
  { route: "/portal/mental", heritageRef: "coach_observations", label: "Mental", sprint: "E", group: "E4", auth: "portal", status: "done" },
  // E5 — Administrasjon
