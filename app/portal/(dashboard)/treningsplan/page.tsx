      ...
      <div className="max-w-[1200px] mx-auto space-y-8">
          ...
          {weekDays.map((day) => {
            ...
            return (
              ...
              >
                ...
                <p className={`text-xl font-bold mb-2 ${day.isToday ? "text-[var(--color-grey-900)]" : "text-[var(--color-grey-900)]"}`}>
                  {day.dateNum}
                </p>
        ...
        <BentoGrid gap="md">
              ...
              {todaySession.exercises && (
                <div className="space-y-2">
                  {todaySession.exercises.map((exercise, idx) => (
                    <div
                      key={idx}
                      className="flex gap-3 p-4 rounded-xl bg-[var(--color-grey-100)]0 border border-[var(--color-grey-100)] hover:border-[var(--color-grey-200)] transition-colors"
                    >
                      <div className="w-7 h-7 rounded-full bg-[var(--color-grey-100)] flex items-center justify-center text-sm font-semibold text-[var(--color-grey-900)] flex-shrink-0">
                        {idx + 1}
                      </div>
                      <div className="flex-1">
          ...
          <BentoCard
            ...
            icon={MessageSquare}
          >
            <div className="p-4 bg-white/60 rounded-xl border border-[var(--color-grey-200)]/30">
        ...
        {!plan && (
          <AppleCard variant="glass" padding="lg" hover={false} className="text-center">
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <h3 className="text-xl font-bold text-[var(--color-grey-900)] mb-2">Ingen aktiv treningsplan</h3>
              <p className="text-[var(--color-grey-500)] max-w-md mb-6">
                {canGenerate
