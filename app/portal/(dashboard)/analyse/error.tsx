  ...
  return (
    <div className="flex items-center justify-center min-h-[50vh]">
      <div className="text-center">
        ...
        <button
          onClick={reset}
          className="inline-flex items-center gap-2 px-5 py-2.5 bg-on-surface text-surface rounded-full text-sm font-semibold hover:bg-on-surface/80 transition-colors"
        >
