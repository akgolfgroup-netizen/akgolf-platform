  ...
  return (
    <div className="space-y-6 animate-pulse">
      ...
      <div className="bg-white rounded-[20px] border border-[var(--color-grey-200)] p-5">
        <div className="h-4 w-36 bg-[var(--color-grey-200)] rounded mb-4" />
        <div className="h-64 bg-[var(--color-grey-100)] rounded-lg" />
      </div>

      {/* Secondary chart */}
      <div className="bg-white rounded-[20px] border border-[var(--color-grey-200)] p-5">
        <div className="h-4 w-28 bg-[var(--color-grey-200)] rounded mb-4" />
        <div className="h-48 bg-[var(--color-grey-100)] rounded-lg" />
      </div>
    </div>
  );
}
