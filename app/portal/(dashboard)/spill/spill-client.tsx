          ...
          <div className="flex items-center gap-2 mb-4">
            <div className="flex -space-x-2">
              {activeSession.Players.map((player, i) => (
                <div
                  key={player.userId}
                  className="w-8 h-8 rounded-full bg-grey-50 border-2 border-white flex items-center justify-center text-xs font-bold text-black"
                >
            ...
            {initialCourses.slice(0, 4).map((course, index) => (
              <PremiumCard key={course.id} delay={index * 0.1} className="!p-4 bg-white border border-grey-200 rounded-xl hover:border-grey-300 transition-colors">
                <div className="flex items-start justify-between">
                  ...
                  <span className="px-2 py-1 rounded-full bg-grey-50 text-xs font-medium text-grey-400">
                    Par {course.par}
                  </span>
                </div>
              </PremiumCard>
          ...
          <div className="space-y-3">
            {initialChallenges.map((challenge) => {
              ...
              return (
                <div
                  key={challenge.id}
                  className="p-4 rounded-xl bg-grey-50 flex items-center justify-between"
                >
                  <div>
                    <div className="flex items-center gap-2">
                      <h4 className="font-medium text-black">
          ...
          >
            {createdSession ? (
              <div className="text-center">
                ...
                <div className="bg-grey-50 rounded-xl p-4 mb-6">
              ...
              <>
                ...
                <div className="mb-4">
                  ...
                  {!selectedCourse && searchResults.length > 0 && (
                    <div className="mt-2 max-h-40 overflow-y-auto rounded-xl border border-grey-200 divide-y divide-grey-200">
                      {searchResults.map((course) => (
                        <button
                          ...
                          className="w-full px-3 py-2 text-left hover:bg-grey-50 transition-colors text-sm"
                        >
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-grey-200 bg-white text-sm text-black placeholder:text-grey-400 focus:outline-none focus:ring-2 focus:ring-black/10 focus:border-grey-300"
                  />
                </div>
                    ...
                    {Object.entries(FORMAT_LABELS).map(([value, label]) => (
                      <button
                        ...
                        className={`px-3 py-2 rounded-xl text-sm font-medium transition-colors ${
                          newGameFormat === value
                            ? "bg-black text-white"
                            : "bg-grey-50 text-black hover:bg-grey-200/50"
                        }`}
                      >
                        {label}
                      </button>
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-[70]">
          ...
          >
            ...
            <input
              ...
              maxLength={6}
              className="w-full px-4 py-3 rounded-xl border border-grey-200 bg-white text-center text-2xl font-bold tracking-[0.3em] uppercase text-black placeholder:text-grey-400 focus:outline-none focus:ring-2 focus:ring-black/10 focus:border-grey-300"
            />
