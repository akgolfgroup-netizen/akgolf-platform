...
const CONFETTI_PARTICLES = [
  { id: 0, color: "#0A1F18", left: 15, x: 45, duration: 2.5, delay: 0.1 },
  { id: 1, color: "var(--color-success)", left: 28, x: -32, duration: 3.2, delay: 0.2 },
  { id: 2, color: "#7A8C85", left: 42, x: 18, duration: 2.8, delay: 0.05 },
  { id: 3, color: "var(--color-success)", left: 55, x: -65, duration: 3.5, delay: 0.3 },
  { id: 4, color: "#0A1F18", left: 68, x: 28, duration: 2.2, delay: 0.15 },
  { id: 5, color: "#A5B2AD", left: 82, x: -42, duration: 3.8, delay: 0.25 },
  { id: 6, color: "#7A8C85", left: 12, x: 55, duration: 2.6, delay: 0.35 },
  { id: 7, color: "var(--color-success)", left: 35, x: -15, duration: 3.0, delay: 0.08 },
  { id: 8, color: "#0A1F18", left: 48, x: 72, duration: 2.4, delay: 0.22 },
  { id: 9, color: "var(--color-success)", left: 62, x: -48, duration: 3.3, delay: 0.12 },
  { id: 10, color: "#A5B2AD", left: 75, x: 38, duration: 2.7, delay: 0.4 },
  { id: 11, color: "var(--color-success)", left: 88, x: -25, duration: 3.6, delay: 0.18 },
  { id: 12, color: "#0A1F18", left: 22, x: 62, duration: 2.3, delay: 0.28 },
  { id: 13, color: "#7A8C85", left: 38, x: -55, duration: 3.1, delay: 0.38 },
  { id: 14, color: "#A5B2AD", left: 52, x: 35, duration: 2.9, delay: 0.02 },
  { id: 15, color: "var(--color-success)", left: 65, x: -72, duration: 3.4, delay: 0.32 },
  { id: 16, color: "#0A1F18", left: 78, x: 22, duration: 2.1, delay: 0.42 },
  { id: 17, color: "#7A8C85", left: 92, x: -38, duration: 3.7, delay: 0.06 },
  { id: 18, color: "#A5B2AD", left: 8, x: 48, duration: 2.5, delay: 0.16 },
