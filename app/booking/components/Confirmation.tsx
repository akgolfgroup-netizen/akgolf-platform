...
const CONFETTI_PARTICLES = [
  { id: 0, color: "#005840", left: 15, x: 45, duration: 2.5, delay: 0.1 },
  { id: 1, color: "var(--color-success)", left: 28, x: -32, duration: 3.2, delay: 0.2 },
  { id: 2, color: "#A5B2AD", left: 42, x: 18, duration: 2.8, delay: 0.05 },
  { id: 3, color: "var(--color-success)", left: 55, x: -65, duration: 3.5, delay: 0.3 },
  { id: 4, color: "#005840", left: 68, x: 28, duration: 2.2, delay: 0.15 },
  { id: 5, color: "#A5B2AD", left: 82, x: -42, duration: 3.8, delay: 0.25 },
  { id: 6, color: "#A5B2AD", left: 12, x: 55, duration: 2.6, delay: 0.35 },
  { id: 7, color: "var(--color-success)", left: 35, x: -15, duration: 3.0, delay: 0.08 },
  { id: 8, color: "#005840", left: 48, x: 72, duration: 2.4, delay: 0.22 },
  ...
  { id: 12, color: "#005840", left: 22, x: 62, duration: 2.3, delay: 0.28 },
  { id: 13, color: "#A5B2AD", left: 38, x: -55, duration: 3.1, delay: 0.38 },
  ...
  { id: 16, color: "#005840", left: 78, x: 22, duration: 2.1, delay: 0.42 },
  { id: 17, color: "#A5B2AD", left: 92, x: -38, duration: 3.7, delay: 0.06 },
