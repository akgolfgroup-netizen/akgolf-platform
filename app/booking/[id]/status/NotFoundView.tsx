    ...
    <div className="min-h-screen bg-surface-container flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="bg-surface-container-lowest rounded-2xl border border-outline-variant p-8 text-center">
          <div className="w-16 h-16 rounded-2xl bg-surface-container flex items-center justify-center mx-auto mb-6">
            <Icon name="search" className="w-8 h-8 text-on-surface-variant" />
          </div>
          ...
          <div className="flex flex-col gap-3">
            <Link
              href="/booking"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-on-surface text-surface rounded-full text-sm font-medium hover:bg-on-surface-variant transition-colors"
            >
              Gå til booking
            </Link>
            <Link
              href="/portal/login"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 border border-outline-variant text-on-surface-variant rounded-full text-sm font-medium hover:bg-surface-container transition-colors"
            >
