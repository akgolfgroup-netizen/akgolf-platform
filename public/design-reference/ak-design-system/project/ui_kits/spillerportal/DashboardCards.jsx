    ...
    <Card theme={theme} glow style={{ gridRow: "span 2", padding: 18 }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          <span style={{ fontSize: 11, color: fg, fontWeight: 600, ...font }}>🏌 68 slag</span>
...
function HandicapCard({ theme }) {
  ...
  return (
    <Card theme={theme}>
      <CardHeader icon="🏌" title="Handicap" theme={theme} />
...
function HeroCard({ theme }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ position: "absolute", top: "15%", left: "50%", transform: "translateX(-50%)", fontSize: 80, opacity: 0.6 }}>🏌️</div>
      <div style={{
...
function PuttingCard({ theme }) {
  ...
  return (
    <Card theme={theme}>
      <CardHeader icon="🏌" title="Putting" theme={theme} />
...
function TrainingStatusCard({ theme }) {
  ...
  return (
    <Card theme={theme}>
      <CardHeader icon="💧" title="Treningsstatus" theme={theme} />
  ...
  return (
    <Card theme={theme}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <span style={{ fontSize: 11, color: mutedFg, ...font }}>⚡ Bra</span>
          <span style={{ fontSize: 28, fontWeight: 800, color: fg, ...font }}>8,5</span>
        </div>
        <span style={{ fontSize: 11, color: mutedFg, ...font }}>🕐 7t 45m</span>
      </div>
    </Card>
  );
}
