...
Tokens, fonter og sidebar/nav er migrert til Heritage Grid. Nå må hver side få riktig layout, komponent-struktur og innhold-hierarki mot BG V2.0-referansen.
