...
[loader](https://ui.aceternity.com/categories/loader) [special](https://ui.aceternity.com/categories/special) [utility](https://ui.aceternity.com/categories/utility)

PreviewCode

`npx shadcn@latest add @aceternity/multi-step-loader-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/multi-step-loader-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/multi-step-loader-demo.json)

Click to load

## [Link to section](https://ui.aceternity.com/components/multi-step-loader\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/multi-step-loader\#props) Props
