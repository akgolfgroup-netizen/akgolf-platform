    ...
    <div>
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-xs">
          <thead>
            <tr className="text-[10px] text-[var(--color-grey-400)] uppercase tracking-wider">
          ...
          <tbody>
            {holes.map((hole, i) => (
              <tr key={hole.hole} className="border-t border-[var(--color-grey-200)]">
                <td className="py-1.5 px-1 font-semibold text-[var(--color-grey-900)]">{hole.hole}</td>
                <td className="py-1.5 px-1">
                  <select
                    value={hole.par}
                    onChange={(e) => updateHole(i, "par", parseInt(e.target.value))}
                    className="w-full bg-transparent text-[var(--color-grey-900)] text-center outline-none"
                  >
                ...
                <td className="py-1.5 px-1">
                  <input
                    ...
                    className="w-full bg-transparent text-[var(--color-grey-900)] outline-none placeholder:text-[var(--color-grey-400)]/30"
                  />
                </td>
                <td className="py-1.5 px-1">
                  <input
