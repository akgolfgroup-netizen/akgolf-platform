-- Prisma-stub for RLS-migration
-- Applied manually via prisma/manual-migrations/2026-05-03_enable_rls.sql
-- Markert som applied via: npx prisma migrate resolve --applied 20260503_enable_rls_round_trackman_group
--
-- Kun til stede slik at fremtidige miljøer som setter opp fra scratch
-- får RLS-policies. Aldri kjør Prisma migrate dev mot prod for denne.
--
